          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-green-600">Verified Member</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                <button
                  onClick={click}
                  className="w-full flex items-center justify-between p-4 bg-red-50 hover:bg-red-100 border border-red-200 rounded-xl transition-all duration-200 group"
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      <p className="font-semibold text-gray-900">Report Missing Child</p>
                      <p className="text-sm text-gray-600">File an emergency alert</p>
                    </div>
                  </div>
                ...
                <button className="w-full flex items-center justify-between p-4 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-xl transition-all duration-200 group">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      <p className="font-semibold text-gray-900">View Active Alerts</p>
                      <p className="text-sm text-gray-600">Check recent reports</p>
                    </div>
                  </div>
                ...
                <button className="w-full flex items-center justify-between p-4 bg-green-50 hover:bg-green-100 border border-green-200 rounded-xl transition-all duration-200 group">
                  <div className="flex items-center space-x-3">
