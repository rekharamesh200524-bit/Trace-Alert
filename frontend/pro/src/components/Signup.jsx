...
const App = () => {
  ...
  const click = async (e) => {
    ...
    try {
      const sign = await axios.post('http://localhost:3000/api/signup', val)
  ...
  const InputStyles = "w-full px-5 py-3 border-2 border-red-600/30 rounded-xl bg-gray-900/50 text-white placeholder-gray-400 focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-500/50 transition duration-300 shadow-inner shadow-black/50";
  const LabelStyles = "block text-sm font-bold text-red-300 mb-2 uppercase";
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-inter text-gray-100 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full sm:mx-auto">
        
        {/* Header Section */}
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="flex justify-center">
            {/* Central Warning Icon: High contrast Red and White */}
        ...
        {/* Signup Card: Translucent Dark Card with dramatic border/shadow */}
        <div className="mt-10 bg-gray-800/80 backdrop-blur-sm py-12 px-8 shadow-2xl shadow-red-800/40 rounded-3xl sm:px-10 border-t-8 border-red-600 transition duration-500 hover:shadow-red-500/60">
          
          <p className="mb-8 text-center text-sm text-gray-300 font-medium">
            Create your account to gain full access to the surveillance system.
          </p>
          ...
          <form className="space-y-6" onSubmit={click}>
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Choose an agent handle"
                />
              </div>
              ...
              <div>
                <label htmlFor="repassword" className={LabelStyles}>
                  Confirm Password
                </label>
                <input
                  id="repassword"
            ...
            <div className="text-center pt-2">
              <p className="text-xs text-gray-500">
                By signing up, you agree to our <a href="/terms" className="text-red-400 hover:text-red-300">Terms of Service</a> and <a href="/privacy" className="text-red-400 hover:text-red-300">Privacy Policy</a>
              </p>
            </div>
          </form>
          ...
          <div className="text-center mt-6 pt-6 border-t border-gray-700/50">
            <p className="text-sm text-gray-400">
              Already a registered agent?{' '}
              <a href="/login" className="font-bold text-red-400 hover:text-red-300 transition duration-200">
                Log In
              </a>
            </p>
          </div>
